...
export async function runMapleTest() {
    console.log("[maple] ── starting Layer 4 test query ──");
    for await (const message of query({
        prompt: "Give me 3 interesting facts about Animal Crossing video games. Be concise — one sentence each.",
        options: {
            systemPrompt: "You are Maple, a sweet and curious bear cub villager. Keep responses short and friendly.",
